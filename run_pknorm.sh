...
time python $script_folder'pknorm_0326.py' -r LSK_BM.atacrep.1196.bamtobed5endintersect.signal -t LSK_BM.atacrep.987.bamtobed5endintersect.signal -m 1 -i 2 -f 0.05 -n 100000 -l 10000 -a 100000 -b 0 -s $script_folder -p z

time python $script_folder'pknorm_check_dif.py' -r LSK_BM.atacrep.1196.bamtobed5endintersect.signal -t LSK_BM.pknorm.txt -f 0.05 -s $script_folder -p z

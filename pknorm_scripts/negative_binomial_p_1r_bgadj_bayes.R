...
nb_pval = apply(sig_input, MARGIN=1, function(x) get_pval(x[1], bin_num, sig_0_size * (x[2]+1)/(input_0_mean+1), sig_0_prob, obs_0_num) )
...
mean_vec[1] = sig_0_mean
var_vec[1] = sig_0_var
size_vec[1] = sig_0_size
prob_vec[1] = sig_0_prob

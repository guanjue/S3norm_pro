...
d1_raw_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig1_raw, '.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
d2_raw = scan(sig2_raw)
#d2_raw_nbp = p.adjust(nbp_2r(d2_raw, 0.001, paste(sig2_raw, '.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
d2_raw_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig2_raw, '.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
...
d2_QTnorm_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig1_raw, '.QTnorm.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
...
d2_QTnorm_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig2_raw, '.QTnorm.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
...
d2_PKnorm_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig2_raw, '.PKnorm.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
...
d2_TRnorm_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig2_raw, '.TRnorm.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh
...
d2_MAnorm_nbp = p.adjust(read.table(paste(output_name, '_difnorm_compare/', sig2_raw, '.MAnorm.nbp_2r.txt', sep='')), method='fdr') < fdr_thresh

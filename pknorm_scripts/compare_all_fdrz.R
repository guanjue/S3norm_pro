...
d1_raw_log2 = log2(d1_raw+0.1)
d1_raw_nbp = p.adjust(2*pnorm(-abs((d1_raw_log2-mean(d1_raw_log2))/sd(d1_raw_log2))), method='fdr') < fdr_thresh
...
d2_raw_log2 = log2(d2_raw+0.1)
d2_raw_nbp = p.adjust(2*pnorm(-abs((d2_raw_log2-mean(d2_raw_log2))/sd(d2_raw_log2))), method='fdr') < fdr_thresh
...
d1_QTnorm_log2 = log2(d1_QTnorm+0.1)
d1_QTnorm_nbp = p.adjust(2*pnorm(-abs((d1_QTnorm_log2-mean(d1_QTnorm_log2))/sd(d1_QTnorm_log2))), method='fdr') < fdr_thresh
...
d2_QTnorm_log2 = log2(d2_QTnorm+0.1)
d2_QTnorm_nbp = p.adjust(2*pnorm(-abs((d2_QTnorm_log2-mean(d2_QTnorm_log2))/sd(d2_QTnorm_log2))), method='fdr') < fdr_thresh
...
d2_PKnorm_log2 = log2(d2_PKnorm+0.1)
d2_PKnorm_nbp = p.adjust(2*pnorm(-abs((d2_PKnorm_log2-mean(d2_PKnorm_log2))/sd(d2_PKnorm_log2))), method='fdr') < fdr_thresh
...
d2_TRnorm_log2 = log2(d2_TRnorm+0.1)
d2_TRnorm_nbp = p.adjust(2*pnorm(-abs((d2_TRnorm_log2-mean(d2_TRnorm_log2))/sd(d2_TRnorm_log2))), method='fdr') < fdr_thresh
...
d2_MAnorm_log2 = log2(d2_MAnorm+0.1)
d2_MAnorm_nbp = p.adjust(2*pnorm(-abs((d2_MAnorm_log2-mean(d2_MAnorm_log2))/sd(d2_MAnorm_log2))), method='fdr') < fdr_thresh

...
d1_raw_nbp = p.adjust(2*pnorm(-abs((d1_raw-mean(d1_raw))/sd(d1_raw))), method='fdr') < fdr_thresh
...
d2_raw_nbp = p.adjust(2*pnorm(-abs((d2_raw-mean(d2_raw))/sd(d2_raw))), method='fdr') < fdr_thresh
...
d1_QTnorm_nbp = p.adjust(2*pnorm(-abs((d1_QTnorm-mean(d1_QTnorm))/sd(d1_QTnorm))), method='fdr') < fdr_thresh
...
d2_QTnorm_nbp = p.adjust(2*pnorm(-abs((d2_QTnorm-mean(d2_QTnorm))/sd(d2_QTnorm))), method='fdr') < fdr_thresh
...
d2_PKnorm_nbp = p.adjust(2*pnorm(-abs((d2_PKnorm-mean(d2_PKnorm))/sd(d2_PKnorm))), method='fdr') < fdr_thresh
...
d2_TRnorm_nbp = p.adjust(2*pnorm(-abs((d2_TRnorm-mean(d2_TRnorm))/sd(d2_TRnorm))), method='fdr') < fdr_thresh
...
d2_MAnorm_nbp = p.adjust(2*pnorm(-abs((d2_MAnorm-mean(d2_MAnorm))/sd(d2_MAnorm))), method='fdr') < fdr_thresh
